...
```bash
sudo curl -L -o /usr/local/bin/deployr https://github.com/Mananm2004/deployr/releases/download/v1.2.0/deployr-linux-amd64 && sudo chmod +x /usr/local/bin/deployr
```

#### macOS (ARM/M1)

```bash
sudo curl -L -o /usr/local/bin/deployr https://github.com/Mananm2004/deployr/releases/download/v1.2.0/deployr-macos-arm64 && sudo chmod +x /usr/local/bin/deployr
```

#### Linux (ARM64):

```bash
sudo curl -L -o /usr/local/bin/deployr https://github.com/Mananm2004/deployr/releases/download/v1.2.0/deployr-linux-arm64 && sudo chmod +x /usr/local/bin/deployr
```

#### macOS (Intel/AMD64):

```bash
sudo curl -L -o /usr/local/bin/deployr https://github.com/Mananm2004/deployr/releases/download/v1.2.0/deployr-macos-amd64 && sudo chmod +x /usr/local/bin/deployr
```
...
You can find the main.yml file here : [main.yml](https://github.com/Mananm2004/deployr/blob/main/workflow/main.sample.yml)
